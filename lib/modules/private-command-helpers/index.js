...
PrivateCommandHelpers.prototype.announceCharacterNotFound = function (player, message) {
  var stringBuilder = new StringBuilder();
...
PrivateCommandHelpers.prototype.announceLogsNotFound = function (player, message) {
  var stringBuilder = new StringBuilder();
...
PrivateCommandHelpers.prototype.announceParses = function (parses, bossName, difficulty, message) {
  message.content = "! parses-announce " + bossName + " " + difficulty + " ";
