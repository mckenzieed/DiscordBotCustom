...
module.exports = new Clapp.Command({
  ...
  fn: (argv, context) => {
    ...
    var guild = argv.args.guild == "default" ? "Months+Behind" : helpers.prettify(argv.args.guild.replace("-", "+"));
    var realm = argv.args.realm == "default" ? "Proudmoore" : helpers.prettify(argv.args.realm);
    var region = argv.args.region == "default" ? "US" : argv.args.region.toUpperCase();
    ...
    crawler.crawler.queue([{
        ...
        callback: function (error, result) {
            ...
            if (error) {
              ...
              if (rankJson == null) {
                pcHelpers.announceNotFound(guildObject, context.msg);
                return;
              }
